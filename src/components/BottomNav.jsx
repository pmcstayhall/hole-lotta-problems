    ...
    <nav className="flex border-t border-gray-200 bg-white safe-area-inset-bottom">
      {tabs.map(({ to, label, icon }) => (
        <NavLink
          ...
          to={to}
          className={({ isActive }) =>
            `flex flex-col items-center justify-center flex-1 py-1.5 gap-0.5 text-xs font-medium transition-colors ${
              isActive
                ? 'text-orange-500'
